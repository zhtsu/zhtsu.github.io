---
title: pygame做游戏：环境搭建
date: 2021-04-28
description: 环境搭建保姆界别教程
category: 游戏开发
---
...
**pygame是python的一个第三方游戏开发库，使用pygame做游戏前需要先进行python开发环境的搭建（Windows10系统）。**


**如果你对python以及pip已经足够熟悉了，那使用pip安装完pygame后，就可以跳过这篇文章了。**
...
![python安装界面-00](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装界面-00.png)
...
![python安装界面-01](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装界面-01.png)
...
![python安装界面-02](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装界面-02.png)
![python安装界面-03](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装界面-03.png)


看到如下界面即说明已经安装完成，点击**Close**退出。


![python安装界面-04](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装界面-04.png)
...
![python本地环境配置-00](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-00.png)
![python本地环境配置-01](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-01.png)


之后会看到如下界面。我们找到其中的**Path**这一行并双击。这一行是本地环境变量的配置，只有添加到其中的内容才可以被本地直接调用。


![python本地环境配置-02](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-02.png)
...
![python本地环境配置-03](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-03.png)
...
![python本地环境配置-04](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-04.png)


这里有一个需要注意的地方，如果你的电脑之前没有超过一个的环境变量，那你双击**Path**之后弹出来会是像下面这样的一个界面。


![python本地环境配置-05](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-05.png)
...
![python本地环境配置-06](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-06.png)
![python本地环境配置-07](/blogs_img/Python/pygame做游戏-00-环境搭建/python本地环境配置-07.png)
...
![键盘Win键](/blogs_img/Python/pygame做游戏-00-环境搭建/键盘Win键.png)


![python环境检查-00](/blogs_img/Python/pygame做游戏-00-环境搭建/python环境检查-00.png)


确定之后会弹出一个cmd控制台窗口，如下图。


![python环境检查-01](/blogs_img/Python/pygame做游戏-00-环境搭建/python环境检查-01.png)


输入 **python** 后回车，若出现以下界面，表示python环境配置无误。


![python环境检查-02](/blogs_img/Python/pygame做游戏-00-环境搭建/python环境检查-02.png)
...
![python环境检查-03](/blogs_img/Python/pygame做游戏-00-环境搭建/python环境检查-03.png)
...
![python安装pygame-00](/blogs_img/Python/pygame做游戏-00-环境搭建/python安装pygame-00.png)
...
![配置vscode的python环境-00](/blogs_img/Python/pygame做游戏-00-环境搭建/配置vscode的python环境-00.png)
...
![配置vscode的python环境-01](/blogs_img/Python/pygame做游戏-00-环境搭建/配置vscode的python环境-01.png)


接下来搜索**python**，同样的操作给VSCode安装上python支持插件。


![配置vscode的python环境-02](/blogs_img/Python/pygame做游戏-00-环境搭建/配置vscode的python环境-02.png)
...
![配置vscode的python环境-03](/blogs_img/Python/pygame做游戏-00-环境搭建/配置vscode的python环境-03.png)


上图写了python的第一个程序，点击运行后，如果如下图在VSCode终端输出了"Hello World"，即表示已经可以开始使用VSCode编写python程序了。


![配置vscode的python环境-04](/blogs_img/Python/pygame做游戏-00-环境搭建/配置vscode的python环境-04.png)
